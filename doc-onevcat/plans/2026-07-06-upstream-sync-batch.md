...
`doc-onevcat/change-list.md` baseline should be advanced to `bcbc4059` only after the PRs from this
batch have merged.
...
After all PRs merge: advance `doc-onevcat/change-list.md` baseline to `bcbc4059` (2026-07-06) with a
